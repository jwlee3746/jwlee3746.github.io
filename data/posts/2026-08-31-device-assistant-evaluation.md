...
permalink: /posts/device-assistant-evaluation/
legacyUrl: /blog/Agent/device-assistant-evaluation/
toc: true
---
...
![디바이스 어시스턴트의 요청이 실제 상태 변화로 이어지는 일반화된 evaluation episode](/data/images/posts/device-assistant-evaluation/device-assistant-evaluation-episode.svg)
...
![고정 replay부터 실제 기기 검증까지 확장되는 디바이스 어시스턴트 평가 계층](/data/images/posts/device-assistant-evaluation/device-assistant-evaluation-layers.svg)
...
관련 글: [재현 가능한 LLM 에이전트 평가 파이프라인](/posts/reproducible-agent-evaluation/) · [TC 기반 vs simulator 기반 평가](/posts/test-case-vs-simulator-evaluation/)
