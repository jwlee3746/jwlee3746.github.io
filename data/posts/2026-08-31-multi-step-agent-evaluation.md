...
- Replay
- Test Design
permalink: /posts/multi-step-agent-evaluation/
legacyUrl: /blog/Agent/multi-step-agent-evaluation/
toc: true
---

[시리즈 허브](/posts/reproducible-agent-evaluation/) · 구현 노트 2/4
...
![정답 누출 없이 multi-step을 재현하는 시퀀스 다이어그램](/data/images/posts/multi-step-agent-evaluation/multi-step-replay-sequence.svg)
...
이전: [구현 노트 1. 평가 계약과 검증 경계](/posts/evaluation-contract-validation/)

다음: [구현 노트 3. 경로 채점의 함정과 discovery continuation](/posts/agent-path-scoring/)
