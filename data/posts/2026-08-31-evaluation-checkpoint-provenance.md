...
- Reproducibility
- Observability
permalink: /posts/evaluation-checkpoint-provenance/
legacyUrl: /blog/Agent/evaluation-checkpoint-provenance/
toc: true
---

[시리즈 허브](/posts/reproducible-agent-evaluation/) · 구현 노트 4/4
...
![장시간 평가의 checkpoint와 resume 시퀀스](/data/images/posts/evaluation-checkpoint-provenance/checkpoint-resume-sequence.svg)
...
![평가 artifact에 포함할 provenance와 비교 경계](/data/images/posts/evaluation-checkpoint-provenance/provenance-comparison-block.svg)
...
이전: [구현 노트 3. 경로 채점의 함정과 discovery continuation](/posts/agent-path-scoring/)
