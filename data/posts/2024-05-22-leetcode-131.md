...
excerpt: "리트코드 131번 문제 풀이."
date: 2024-05-22
permalink: /blog/Algorithm/Algorithm1/
tags: ["Algorithm"]
toc: true
---
...
class Solution:
    def partition(self, s: str) -> List[List[str]]:
        ...
        return rec(0)
```
![1round](/data/images/posts/leetcode-131/top-down-result.png)\
...
class Solution:
    def partition(self, s: str) -> List[List[str]]:
        ...
        return dp[0]
```
![3round](/data/images/posts/leetcode-131/bottom-up-result.png)
